      ...
      campanha.forEach((campaign, index) => {
        setTimeout(() => {
          ...
          boxgame.innerHTML = `
            ...
            <h4 class="match">
              <img class="flag-modal" src="/Eurocup-AmericaCup-top-score-main/src/icones/${campaign.champion}.png" alt="imagem seleção ${campaign.champion}"/>
              <span class="goals">${campaign.goals_champions}</span>
              ${campaign.match}
              <span class="goals">${campaign.goals_opponent}</span>
              <img class="flag-modal" src="/Eurocup-AmericaCup-top-score-main/src/icones/${campaign.opponent}.png" alt="imagem seleção ${campaign.opponent}"/>
            </h4>
